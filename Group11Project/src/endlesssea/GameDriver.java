...
import endlesssea.states.TextEventState;
import endlesssea.states.*;
...
//        for(int i = 0; i < 5; i++) {
//            marineList.add(i, endlesssea.textures.createSprite(endlesssea.textures.britishMarine, 0, 0, 65, 185));
