...
import endlesssea.gamelogic.EnemyShip;
import endlesssea.GameDriver;
import endlesssea.gamelogic.PlayerShip;
import endlesssea.Textures;
import endlesssea.events.EventExampleDriver;
import endlesssea.gamelogic.ShipSection;
...
//        int[] shipStats = eventDriver.getEventEffects();
//        enemyShip = new EnemyShip(shipStats, endlesssea.textures, driver, window, EnemyShip.ShipType.STANDARD, (float)0.5, 500, 800);
