package endlesssea.events;// STUBBED FILE
import java.sql.*;
...
public class DbUser extends DbBasic {
	...
	public ArrayList getQuery(String query, String[] titles)
	{
		...
		try{
			...
			System.out.println("Something went wrong ***endlesssea.events.DbUser getQuery***  " + query);
		}
		return results;
	}
	...
	public void execute(String query)
	{
		try{
			...
			System.out.println("Something went wrong ***endlesssea.events.DbUser execute***");
		}
	}
}
