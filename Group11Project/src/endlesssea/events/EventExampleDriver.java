...
{
    private String[] eventTypes = {"Assist endlesssea.events.Events", "Combat endlesssea.events.Events", "Exploration endlesssea.events.Events", "Text endlesssea.events.Events", "Trade endlesssea.events.Events"};
